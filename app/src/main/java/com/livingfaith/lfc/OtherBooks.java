...
public class OtherBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = (TextView) findViewById(R.id.announce_error_test);
        //getting a refernce to the progressbar view
        pd = (ProgressBar) findViewById(R.id.loading_spinner_test);
        ...
        webView.loadUrl("https://favouritemall.com/testimonies/");
