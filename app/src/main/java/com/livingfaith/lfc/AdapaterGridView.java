...
public class AdapaterGridView extends ArrayAdapter<GridViewItem_2> {
    Context mContext;
    int resourceId;

    ArrayList<GridViewItem_2> data = new ArrayList<GridViewItem_2>();

    public AdapaterGridView(Context context, int layoutResourceId, ArrayList<GridViewItem_2> data) {
