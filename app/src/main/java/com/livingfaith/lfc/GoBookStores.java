...
public class GoBookStores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = (TextView) findViewById(R.id.announce_error_dom);
        //getting a refernce to the progressbar view
        pd = (ProgressBar) findViewById(R.id.loading_spinner_dom);

        Inter_Activity main = new Inter_Activity();
        //   if (main.isOnline()) {

        //webView.setWebChromeClient(new WebChromeClient());
        webView = (WebView) findViewById(R.id.webView_dom);
        ...
        webView.loadUrl("https://favouritemall.com/dominion-book-store/");
